...
/* package HTTPServer-0.1.0.0 */
#ifndef VERSION_HTTPServer
#define VERSION_HTTPServer "0.1.0.0"
#endif /* VERSION_HTTPServer */
#ifndef MIN_VERSION_HTTPServer
#define MIN_VERSION_HTTPServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HTTPServer */
...
#define CURRENT_COMPONENT_ID "HTTPServer-0.1.0.0-inplace-HTTPServer"
